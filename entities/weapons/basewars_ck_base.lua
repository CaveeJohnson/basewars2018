...
SWEP.PrintName     = "Basewars2018 Construction Kit Base"
...
if CLIENT then
	surface.CreateFont("bw18_ck_base_weapon_selection_blur", {
		font = "HalfLife2",
		size = 128,
		blursize = 9,
		scanlines = 4,
	...
	surface.CreateFont("bw18_ck_base_weapon_selection", {
		font = "HalfLife2",
		size = 128,
	})

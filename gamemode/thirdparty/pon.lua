...
-- basewars stuff here, this is so if we ever have a better object notation we can easily
-- switch due to abstraction
basewars.serial = {}
basewars.serial.encode = pon.encode
basewars.serial.decode = pon.decode
